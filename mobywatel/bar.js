...
function sendTo(url, top = null, bottom = null) {
    if (top) {
    ...
    // Jeśli chcesz przekierować na assets/app/home.html
    if (url === 'home') {
        location.href = 'D:/mobywatel/home.html';
    } else if (url === 'documents') {
        location.href = 'D:/mobywatel/documents.html';
    } else if (url === 'card') {
        location.href = 'D:/mobywatel/card.html';
    } else {
        // fallback (np. jeśli url to pełna ścieżka)
        location.href = url;
    }
}
